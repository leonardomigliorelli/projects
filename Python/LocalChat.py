...
def createLogin():
    ...
    csv_old = (pd.concat([csv_old, csv])
               if oldCsvExists and not nameAlreadyUsed else csv)  # if old csv file exists concatenate it with the new
